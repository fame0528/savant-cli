...
- READ 0-END BEFORE EDITING - read the ENTIRE file with no offset/limit before any edit
- Verify after edit - read the file back to confirm the change applied correctly
